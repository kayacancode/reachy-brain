...
class Config:
    ...
    clawdbot_token: str = os.environ.get("CLAWDBOT_TOKEN", "aefb7d0e1d524d1f460c6942372c65db7df430e40b9ba7c7")
    clawdbot_model: str = os.environ.get("CLAWDBOT_MODEL", "claude-sonnet-4-20250514")
    openai_api_key: str = os.environ.get("OPENAI_API_KEY", "")
    elevenlabs_api_key: str = os.environ.get("ELEVENLABS_API_KEY", "")
    elevenlabs_voice_id: str = os.environ.get("ELEVENLABS_VOICE_ID", "IKne3meq5aSn9XLyUdCD")
